...
class TransaksiController extends Controller
{
    public function create()
    {
        ...
        return view('admin.transaksi.index', compact('pelanggan', 'produk', 'kode_transaksi'));
    }
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            foreach ($request->produk_id as $index => $produkId) {
                ...
                if ($totalStok < $jumlah) {
                    return redirect()->route('admin.transaksi.index')->with('error', "Stok barang '{$produk->nama_barang}' tidak mencukupi!");
                }
            ...
            DB::commit();
            return redirect()->route('admin.transaksi.nota', ['kode_transaksi' => $laporan->kode_transaksi])
                ->with('success', 'Transaksi berhasil!');
        } catch (\Exception $e) {
            DB::rollBack();
            return redirect()->route('admin.transaksi.index')->with('error', 'Terjadi kesalahan: ' . $e->getMessage());
        }
    }
    ...
    public function nota($kode_transaksi)
    {
        ...
        return view('admin.transaksi.nota', compact('laporan', 'detailTransaksi'));
    }
