                    ...
                    <tbody>
                        @forelse ($barang as $index => $item)
                            <tr>
                                ...
                                <td class="{{ $item->stok < $item->minimal_stok ? 'text-danger fw-bold' : '' }}">
                                    {{ $item->stok }}
                                </td>
                                <td class="text-center">
                                    ...
                                    <form action="#" method="POST" class="d-inline" onsubmit="return confirm('Yakin ingin menghapus barang ini?');">
                                        @csrf
                                        @method('DELETE')
